...
void KatonEnemyView::Initialize(Math::Vector2 ninjaPos, Math::Vector2 attackPos)
{
	...
	katonEnemySprite_.params.siz = Math::Vector2(100.0f, 132.0f); // …“Ù‚Ìp‚Ì“G‚ÌƒTƒCƒY‚ğİ’è
	...
	katonEnemyAttackSprite_.params.siz = Math::Vector2(100.0f, 132.0f); // …“Ù‚Ìp‚ÌUŒ‚‚ÌƒTƒCƒY‚ğİ’è
