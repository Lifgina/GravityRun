...
public:
	...
	void MoveEnemySetup(int enemyID, float enemySpeed, HE::Math::Vector2 initialPos, float maxRange, float minRange);
...
private:
	...
	MoveEnemy moveEnemy_[7]; // 手裏剣のモデル
	SilentEnemy silentEnemy_[7]; // まきびしのモデル
