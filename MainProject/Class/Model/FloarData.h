...
private:
	...
	{ Vector2(40.0f,0.0f),  Vector2(440.0f,0.0f),Vector2(540.0f,0.0f),Vector2(640.0f,0.0f),Vector2(740.0f,0.0f),
	 ...
	 Vector2(40.0f,350.0f), Vector2(140.0f,350.0f),Vector2(240.0f,350.0f),Vector2(640.0f,350.0f),Vector2(740.0f,350.0f),
	...
	//床が壊れる時間
	float breakTime_[25] = {
		0.0f, 15.0f, 0.0f, 30.0f, 0.0f,
		0.0f, 30.0f, 0.0f, 15.0f, 0.0f,
		0.0f, 15.0f, 0.0f, 30.0f, 0.0f,
		0.0f, 30.0f, 0.0f, 15.0f, 0.0f,
		0.5f, 15.0f, 0.0f, 30.0f, 0.0f
	};
